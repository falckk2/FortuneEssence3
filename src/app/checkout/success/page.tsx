      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="bg-white rounded-lg p-4 border border-sage-200">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 text-sm bg-cream-100 text-forest-700 rounded hover:bg-cream-200 transition-colors"
                  >
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8 text-left">
            <h2 className="text-2xl font-semibold text-forest-900 mb-6">
              {locale === 'sv' ? 'Vad händer nu?' : 'What happens next?'}
            </h2>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-sage-100 rounded-full flex items-center justify-center mr-4 mt-1">
                  <span className="text-sage-600 font-semibold text-sm">1</span>
                </div>
                <div>
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-sage-100 rounded-full flex items-center justify-center mr-4 mt-1">
                  <span className="text-sage-600 font-semibold text-sm">3</span>
                </div>
                <div>
                  <h3 className="font-semibold text-forest-900 mb-1">
          ...
          {/* Customer Support */}
          <div className="bg-gradient-to-r from-sage-50 to-yellow-50 rounded-xl p-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/products"
              className="inline-flex items-center px-8 py-3 border-2 border-sage-600 text-sage-600 font-medium rounded-lg hover:bg-sage-50 transition-colors"
            >
            ...
            <Link
              href="/account/orders"
              className="inline-flex items-center px-8 py-3 bg-sage-600 text-white font-medium rounded-lg hover:bg-sage-700 transition-colors"
            >
          ...
          <div className="mt-12 pt-8 border-t border-cream-200">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 px-4 py-2 border border-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sage-500 focus:border-transparent"
                required
              />
              <button
                type="submit"
                className="px-6 py-2 bg-sage-600 text-white font-medium rounded-lg hover:bg-sage-700 transition-colors whitespace-nowrap"
              >
