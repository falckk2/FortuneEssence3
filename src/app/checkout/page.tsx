...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-[#1a1f1e] dark:to-[#242a28] py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-[#E8EDE8]">
            {locale === 'sv' ? 'Kassa' : 'Checkout'}
          </h1>
          <p className="text-gray-600 dark:text-[#B8C5B8] mt-2">
            {locale === 'sv' 
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-2 text-sm text-gray-600 dark:text-[#B8C5B8]">
