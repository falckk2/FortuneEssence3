  ...
  return (
    <div className="min-h-screen bg-cream-50 dark:bg-[#1a1f1e] flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        ...
        {/* Message */}
        <h1 className="text-4xl lg:text-5xl font-serif font-bold text-forest-800 dark:text-[#E8EDE8] mb-4">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mb-8 p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl text-left max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-[#242a28] rounded-3xl shadow-soft p-8">
          ...
          <p className="text-forest-600 dark:text-[#C5D4C5] mb-4">
            {locale === 'sv'
          ...
          <Link
            href="/contact"
            className="text-sage-700 dark:text-sage-400 hover:text-sage-800 dark:hover:text-sage-300 font-semibold hover:underline transition-colors"
          >
